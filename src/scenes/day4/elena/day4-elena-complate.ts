...
import { centeredText, hide, jump, jumpIf, scene, setFlag } from "@/scenes/scriptTypes";
import { mayaDayChangeClassic } from "@/cut-scene/dayChangeBackgrounds";

export const day4ElenaComplateScene: VisualNovelCommand[] = [
