...
export const stayRouteScene: VisualNovelCommand[] = [
  ...
  show("arka-main", "arka", "neutral", { position: "left", enterFrom: "left", yOffset: 100, scale: 1.2 }),
  show("maya-main", "maya", "surprised", { position: "right", enterFrom: "right", yOffset: 60, scale: 1.08 }),
  ...
  moveTo("arka-main", "center", { duration: 800, easing: "ease-in-out" }),
